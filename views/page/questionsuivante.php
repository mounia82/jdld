...
<div class="containerpq">
    ...
    <div class="bruh">
        ...
        <div><a href="?section=replique&categ=<?= $_GET["categ"] ?>&emotion=colere#replique"><img class="imagepq" src="public/images/images2page/killbill.jpg" alt="" data-aos="zoom-in-down" data-aos-duration="1800" data-aos-delay="50"></a></div>



        <div><a href="?section=replique&categ=<?= $_GET["categ"] ?>&emotion=degout#replique"><img class="imagepq" src="public/images/images2page/oldboy.jpg" alt="" data-aos="zoom-in-down" data-aos-duration="1800" data-aos-delay="400"></a></div>



        <div><a href="?section=replique&categ=<?= $_GET["categ"] ?>&emotion=surprise#replique"><img class="imagepq" src="public/images/images2page/seven.jpg" alt="" data-aos="zoom-in-down" data-aos-duration="1800" data-aos-delay="750"></a></div>



        <div><a href="?section=replique&categ=<?= $_GET["categ"] ?>&emotion=mepris#replique"><img class="imagepq" src="public/images/images2page/joker.jpg" alt="" data-aos="zoom-in-down" data-aos-duration="1800" data-aos-delay="1050"></a></div>

    </div>

    <div class="bruh">

        <div><a href="?section=replique&categ=<?= $_GET["categ"] ?>&emotion=tristesse#replique"><img class="imagepq" src="public/images/images2page/greenmile.jpg" alt="" data-aos="zoom-in-down" data-aos-duration="1800" data-aos-delay="1200"></a></div>
        ...
        <div><a href="?section=replique&categ=<?= $_GET["categ"] ?>&emotion=peur#replique"><img class="imagepq" src="public/images/images2page/shining.jpg" alt="" data-aos="zoom-in-down" data-aos-duration="1800" data-aos-delay="2050"></a></div>



        <div><a href="?section=replique&categ=<?= $_GET["categ"] ?>&emotion=autre#replique"><img class="imagepq" src="public/images/images2page/alien.jpg" alt="" data-aos="zoom-in-down" data-aos-duration="1800" data-aos-delay="2400"></a></div>
